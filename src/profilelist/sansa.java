 ...
 * @author user pc
 */
public class sansa extends Scene {
	...
	public sansa(){
		super(root,300,300);
                ...
                UserIDLabel=new Label("Username:13");
                NameLabel=new Label("Name: sansa");
                GenderLabel=new Label("Gender:Female");
                LocationLabel=new Label("Location: TownHall");
                 JoinDateLabel=new Label("Join Date: 31-Nov-2015");

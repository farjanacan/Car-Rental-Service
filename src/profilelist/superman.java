 ...
 * @author user pc
 */
public class superman extends Scene {
	...
	public superman(){
		super(root,300,300);
                ...
                UserIDLabel=new Label("Username:2");
                NameLabel=new Label("Name: superman");
                GenderLabel=new Label("Gender:male");
                LocationLabel=new Label("Location: IcodeBari");
                JoinDateLabel=new Label("1-March-2016");
